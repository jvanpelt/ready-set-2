...
export const LEVEL_CONFIG = [
    {
        level: 1,
        goalScore: 250, // goalScore: 500, (original - reduced for tutorial testing)
...
Drag dice to the solution area and click GO!`
    ...
    {
        level: 2,
        goalScore: 250, // goalScore: 750, (original - reduced for tutorial testing)
...
• More complex solutions = more points!`
    ...
    {
        level: 3,
        goalScore: 250, // goalScore: 1000, (original - reduced for tutorial testing)
...
• Use complements for tricky puzzles!`
    ...
    {
        level: 4,
        goalScore: 250, // goalScore: 1500, (original - reduced for tutorial testing)
        operators: ['UNION', 'INTERSECTION', 'DIFFERENCE', 'COMPLEMENT'],
        tutorial: {
...
• Keep building those complex expressions!`
    ...
    {
        level: 5,
        goalScore: 250, // goalScore: 2500, (original - reduced for tutorial testing)
...
• Try padding your solutions to boost your scores!`
    ...
    {
        level: 6,
        goalScore: 250, // goalScore: 5000, (original - reduced for tutorial testing)
        numDice: 8,
...
Keep an eye out for that green border!`
    ...
    {
        level: 9,
        goalScore: 250, // goalScore: 7500, (original - reduced for tutorial testing)
        numDice: 8,
...
Try different operators until one works - or strategize!`
    ...
    {
        level: 10,
        goalScore: 250, // goalScore: 10000, (original - reduced for tutorial testing)
        numDice: 8,
